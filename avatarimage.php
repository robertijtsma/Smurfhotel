...
$looks = $user['look'];
$look = imagecreatefromgif("https://smurfhotel.nl/smurf-imaging/avatarimage.php?figure='.$looks.'&action=" . $action . "&direction=" . $direction . "&head_direction=" . $head_direction . "&gesture=" . $gesture . "&size=" . $size . "&img_format=gif");
...
// echo "<img src=\"http://habbo.nl/habbo-imaging/avatarimage?figure=".$row['look']."\" alt='".$row['username']."'>";
//        }
// }
?>