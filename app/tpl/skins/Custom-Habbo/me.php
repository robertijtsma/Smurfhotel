...
<a href="{url}/logout" class="new-button red-button" style="margin-right:5px;margin-left:5px;"><b>Log uit</b><i></i></a>
	...
	<div id="content">
		<div class="cbb ">
<span>{online} Smurfjes online</span></div>
...
<br><br>
    <div class="open enter-btn">
            <a href="{url}flashcheck/index.php" target="84ebd05b9eac6717671e77c01c6209a4c8e06d54" onclick="HabboClient.openOrFocus(this); return false;">Ga naar SmurfHotel<i></i></a>
        <b></b>
    </div>
</div>
...
<li class="even">
<iframe src="https://discordapp.com/widget?id=444767923551338497&theme=dark" width="440" height="300" allowtransparency="true" frameborder="0"></iframe>
</li> 
...
<div class="cbb clearfix blue ">
 ...
 <h2 class="title">SmurfFM!</h2> </font>
                                ...
                                <div id="newspromo">
                                    <div id="topstories">
                                        ...
                                        <div class="topstory" style="background-image: url({url}/ase/ts/{newsIMG-2}); display: none">
                                            ...
                                            <p>
                                                <a href="{url}/index.php?url=news&id={newsID-2}">Lees meer &raquo;</a>
                                            </p>
                                        </div>
                                        <div class="topstory" style="background-image: url({url}/ase/ts/{newsIMG-3}); display: none">
                                            ...
                                            <p>
                                                <a href="{url}/index.php?url=news&id={newsID-3}">Lees meer &raquo;</a>
                                            </p>
                                        </div>
                                        <div class="topstory" style="background-image: url({url}/ase/ts/{newsIMG-4}); display: none">
                                            ...
                                            <p>
                                                <a href="{url}/index.php?url=news&id={newsID-4}">Lees meer &raquo;</a>
                                            </p>
                                        </div>
                                        <div class="topstory" style="background-image: url({url}/ase/ts/{newsIMG-5}); display: none">
                                            ...
                                            <p>
                                                <a href="{url}/index.php?url=news&id={newsID-5}">Lees meer &raquo;</a>
                                            </p>
                                        </div>
                                        <div id="topstories-nav" style="display: none"><a href="#" class="prev">&laquo; Vorige</a><span>1</span> / 5<a href="#" class="next">Volgende &raquo;</a></div>
                                    </div>
                                    <ul class="widelist">
...
<h2 class='title' style='font-size:12px;text-align:left;font-family: "Tahoma",Verdana,Arial;'>Bezoek een Smurf.</h2>
...
<div>
<span style="color:green;"> Laden.. </span>
<?php
}else{
echo "No user found...";
}
...
<h2 class="title">Laatste Smurf</h2>
<?php
