...
<div style="margin-top:16px">
									<img src="{url}/app/tpl/skins/{skin}/images/icons/message.gif" /> Welcome terug, <b>{userName}</b>! &nbsp; &nbsp;
                ...
                <div id="navi2" class="pngbg clearfix">
                    <ul>
						...
						<li class=""><a href="{url}/news">Nieuws</a></li>
						 <li class=""><a href="{url}/staff">Medewerkers</a></li>
						<li class=""><a href="{url}/topstats">Top Lijst</a></li>
                    </ul>
                </div>
            </div>
			<div id="container">
                    ...
                    <div id="column1" class="column">
                        <div class="habblet-container ">		
                            <div class="cbb clearfix activehomes ">
                                <h2 class="title">Random Smurfen - Klik op ons!</h2>
...
<div class="cbb clearfix activehomes">
 ...
 <h2 class="title"><font size=1>Smurf's Statistieken! </h2> </font>

<div id="notfound-content" class="box-content"> <center> 

           Smurfen online: <?php $sql = "SELECT COUNT(*) FROM users WHERE online = '1'"; 
$query = mysql_query($sql) or die(mysql_error()); 
$hoeveel = mysql_result($query,0,0); 

echo $hoeveel;  ?> <br> 
Geregistreerde Smurfen:
<?php 
                            ...
                            <div class="cbb clearfix notitle ">
                                <div id="newspromo">
                                    ...
                                    <ul class="widelist">
                                        ...
                                        <li class=""><a href="/news">Meer nieuws &raquo;</a></li>            
                                    </ul>
                                </div>
                                <script type="text/javascript">
