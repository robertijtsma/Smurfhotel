...
if (isset($do))
{
    ...
    <div id="my-tag-info" class="habblet-content-info">
        <?php if($tags_num > 19){ echo "Je hebt je maximale aantal tags bereikt, verwijder een tag om een andere toe te voegen."; } elseif($tags_num == 0){ echo "Je hebt nog geen tags."; } elseif($tags_num < 20){ echo "Je hebt nogsteeds ruimte voor meer tags."; } ?>
    </div>
<div class="box-content">
