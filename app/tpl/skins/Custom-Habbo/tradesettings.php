                        ...
                        <div class="content">
                                    ...
                                    <div class="box-content">
                                        <div id="settingsNavigation">
                                            <ul>
												...
												<li class="selected">Ruil Instellingen</li>
                            ...
                            <div class="habblet-container " style="float:left; width: 560px;">
                                <div class="cbb clearfix settings">
                                    <h2 class="title">Ruil Instellingen</h2>
                                    <div class="box-content">
									<?PHP
									...
									?>
											...
											$ch1[$x1] = "checked";
											echo "
											<h3>Ruilen Aanpassen</h3>
											<p>Wil je dat mensen met je kunnen ruilen?</p>
											<input type='radio' name='ts' value='1' ".$ch1['1'].">Aanzetten
											<input type='radio' name='ts' value='0' ".$ch1['0'].">Uitzetten
											<br><br>
											";
											?>
