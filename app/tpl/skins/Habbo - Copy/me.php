 ...
 <div class='content'>
  <div class='infoarea'>
	<div id="platearea">
	 ...
	 <img src="https://www.habbo.nl/habbo-imaging/avatarimage?figure={figure}&action=sit,wav&gesture=sml&direction=2&head_direction=3&size=n&img_format=png" alt="{username}"></img>
	</div>
	<div class='info'>
	 <h2>{username}</h2><br>
	 <text>• {motto}</text>
	 ...
	 <text>• {points} <img id='pixels' src='{url}/app/tpl/skins/Habbo/images/ducket.png' style='width:20px;height:20px'></text>
	 	 <text></text>
	</div>
