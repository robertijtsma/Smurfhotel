...
<script language="JavaScript">
    ...
    document.onkeydown = function (event) {
        ...
        <script type="text/javascript">
            ...
            "connection.info.host" : "proxy1.proxypoort.nl", 
                "connection.info.port" : "2113", 
                "site.url" : "{url}", 
                "url.prefix" : "{url}", 
            ...
            swfobject.embedSWF(BaseUrl + "/Habbo231.swf", "client", "100%", "100%", "10.0.0", "https://smurfhotel.nl/expressInstall.swf", flashvars, params, null);
        </script>
