  ...
  //--></script>
        ...
        <script type="text/javascript">
            ...
            "connection.info.host" : Prive("<?php echo base64_encode($connection); ?>"), 
                "connection.info.port" : Prive("<?php echo base64_encode(30000); ?>"), 
                "site.url" : "{url}", 
                "url.prefix" : "{url}", 
                "client.reload.url" : "{url}/client", 
                "client.fatal.error.url" : "{url}/me", 
                "client.connection.failed.url" : "{url}/me", 
                "external.variables.txt" : Prive("<?php echo base64_encode("https://smurfhotel.nl/r63/external_variables.txt"); ?>"),
                "external.texts.txt" : Prive("<?php echo base64_encode("https://smurfhotel.nl/r63/external_flash_texts.txt"); ?>"), 
                "productdata.load.url" : Prive("<?php echo base64_encode("https://smurfhotel.nl/r63/productdata.txt"); ?>"), 
