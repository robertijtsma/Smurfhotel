...
<body>
 ...
 <div class='subnaviarea'>
  <div class='subnavi'>
	...
	<a href="{url}/mod">Moderators</a><div class='chosen'>I</div>
	<a href="{url}/exp"><div class='chosen'>eXperts</div></a>
  </div>
 </div>
 <div class='content'>
	<div class='staffs'>
...
global $engine;
                            $GetRanks = $engine->query("SELECT id,name FROM ranks WHERE id =3 ORDER BY id DESC");
