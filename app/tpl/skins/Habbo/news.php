...
<header>
    ...
    <div class="container">
        ...
        <a href="." class="brand" title="Smurf Hotel" alt="Smurf Hotel">Smurf Hotel</a>
    ...
    <nav class="main-navigation">
        ...
        <div class="container">
            ...
            <div class="col-md-12 no-padding">
                <ul class="nav">
                    <li class="active"><img src="./img/home.png" alt="Home" /><a href="https://smurfhotel.nl/me">Home</a></li>
...
<div id="content">
    ...
    <div class="container">
        ...
        <div class="col-xs-7">
            ...
            <div class="news-articles habbo-box">
                ...
                <div class="article-main" style="background-image: url({url}/ase/ts/{newsIMG});">

                    <h3>{newsTitle}</h3>

                    <p>Geschreven op {newsDate}</p>
	...
	<text>{newsList}</text>
    <div class="col-xs-12 form-group setting-row">
