...
<div id="content">
    ...
    <div class="container">
            ...
            <div class="popular-rooms">
                ...
                <div class="room">
                    ...
                    <div class="room-picture">
                        <img src="./img/rooms/1.png" alt="Room 1" />
                    </div>

                    <h3>Discord?</h3>
                    <p>Smurf gebruikt "discord" om bijvoorbeeld nieuws, meldingen en andere zaken te bespreken. Als het niet in het hotel gebeurt dan wel in discord. Daarom is het verstandig om onze discord server te joinen.</p>
                    <p class="owner">Klik op de button aan de rechterkant van deze pagina.</p>
                ...
                <div class="room">
                    ...
                    <h3>Soliciteren?</h3>
                    <p>Soliciteren bij Smurf kan wanneer de soliciaties open staan, het helpt niet om staffs te vragen naar de soliciaties of te vragen naar rank, want dit werkt juist niet. Dan is staff eerder geneigd om je het niet te geven ;).</p>
                    <p class="owner"></p>
        ...
        <div class="col-xs-5">
	  	...
	  	<center><text><a href="https://discord.me/smurfhotel"><img class="imagediscord" src="{url}/app/tpl/skins/Habbo/images/discord.png"/></a></text></center>
            </div>
