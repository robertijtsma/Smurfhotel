            ...
            <div id="navi2-container" class="pngbg">
                <div id="navi2" class="pngbg clearfix">
                   <ul>
                        ...
                        <li class="selected"><a href="{url}/forumstats">Leaderboards</a></li>
        	...
        	<div id="content" style="position: relative" class="clearfix">
                <div class="habblet-container " style="float:left; width: 770px;">
                    <div class="cbb clearfix settings">
                        <h2 class="title">{hotelname} Forum Leaderboards</h2>
                        <div class="box-content">
                            <div style="float: left;">
                                <img src="{url}/app/tpl/skins/Habbo/images/forum/ws_wave.gif" style="float: left;" />
                                Here on the {hotelname} Forum, we collect the latest results of what our users contribute to the forum!
                                This way we can easily pick out users who are active on the forum. So make sure to keep active and prizes may be coming your way!<br />
                                <i>psst! it shows if your good enough for a staff position too ;)</i>.
                                <br /><br />
                                There are monthly prizes to be won, and little forum events which can treat you to many gifts from {hotelname} Staff!
                                So make sure to keep active on your stay here on the hotel, and constantly look on this forum for the latest features, 
            ...
            <div id="content" style="position: relative" class="clearfix">
                <div class="habblet-container " style="width: 770px;">
                    <div class="cbb clearfix orange ">
                        <h2 class="title">Top 10 {hotelname} Posters</h2>
                        <div style="padding: 5px;">
                            <table style="width: 100%;">
                                <tr name="0" style="height: 17px; background-color: #0094cd; color: #fff; font-weight: bold;">
                                    <td style="padding: 5px; width: 320px;">Username</td>
                                    <td style="padding: 5px; width: 100px;">Posts</td>
                                </tr>

                                <?php $forum->getTopPosters(5); ?>
                            </table>
                        </div>
                    </div>
                </div>
