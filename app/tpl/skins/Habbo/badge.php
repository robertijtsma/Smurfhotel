        ...
        <div id="header-container">
            <div id="header" class="clearfix">
                    ...
                    <div id="subnavi-search">
                        <div id="subnavi-search-upper">
                            <ul id="subnavi-search-links">
								<li><a href="{url}/safety" target="_blank" style="color:#000">Safety</a></li>
                                <li><a href="{url}/logout" style="color:#000">Uitloggen</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="to-hotel">
                ...
                <ul id="navi">
					...
					<li><a href="{url}/staff">Medewerkers</a><span></span></li>
					<li class="selected"><a href="{url}/shop">Shop</a><span></span></li>
				
                </ul>
                <div id="habbos-online">
                    <div class="rounded"><span>Smurfen Online!</span></div>
                </div>
            </div>
        </div>
...
<div id="column2" class="column">
                        <div class="habblet-container ">
                            <div class="cbb clearfix blue ">
                                <h2 class="title">Betaalmiddelen</h2>
                                <div style="padding:5px">
            <center>
            <img src='https://www.habbo.nl/habbo-imaging/avatarimage?figure={figure}&action=crr=5&direction=3&head_direction=3&gesture=s&size=3'/>
            <hr>
            <table>
            <tr>
            <td>
            <strong>Credits:</strong></td><td>{coins}
            </td>
            </tr>
            <tr>
            <td>
            <strong>Pixels:</strong></td><td>{activitypoints}
            </td>
            </tr>
			<tr>
            <td>
            <strong>Belcredits:</strong></td><td>{crystals}
            </td>
            </tr>
            </td>
            </tr>
