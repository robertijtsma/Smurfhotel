...
<html lang="en">
    <head>
        ...
        <title>{hotelName} - My Posts</title>
            ...
            <div id="navi2-container" class="pngbg">
                <div id="navi2" class="pngbg clearfix">
                   <ul>
                        ...
                        <li class="selected"><a href="{url}/myposts">My Posts</a></li>
        	...
        	<div id="content" style="position: relative" class="clearfix">
                <div class="habblet-container " style="widthx: 770px; width: 910px;">
                    <div class="cbb clearfix orange ">
                        <h2 class="title">Everything posted by yourself, {username}</h2>
                        <div style="padding: 5px;">
                            <table style="width: 100%;">
                                <tr name="0" style="height: 17px; background-color: #0094cd; color: #fff; font-weight: bold;">
                                    <td style="padding: 5px; width: 350px;">Thread Name</td>
                                    <td style="padding: 5px; width: 120px;">Written On</td>
                                    <td style="padding: 5px; width: 120px;">Last Replied</td>
                                    <td style="padding: 5px; width: 150px;">Category</td>
                                </tr>
                                <?php echo $forum->listMyPosts($u_id); ?>
                            </table>
                        </div>
                    </div>
                </div>
