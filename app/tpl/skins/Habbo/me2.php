...
<head>
        ...
        <script type="text/javascript">
            ...
            var habboImagerUrl = "https://smurfhotel.nl/smurf-imaging/avatarimage.php";
            var habboPartner = "";
 ...
 <div class='content'>
  <div class='infoarea'>
	<div id="platearea">
	 ...
	 <img src="https://habbo.city/habbo-imaging/avatarimage?figure={figure}&action=sit,wav&gesture=sml&direction=2&head_direction=3&size=n&img_format=png" alt="{username}"></img>
	</div>
	<div class='info'>
	 <h2>{username}</h2><br>
	 <text>• {motto}</text>
