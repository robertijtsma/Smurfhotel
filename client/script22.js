...
switch(id)
{
    ...
    $(".news .beschreibung").html("<a class='weiterlesen' href='/nieuws!182'>Lees meer...</a>WK Voetbal SmurfHotel 2.0");
    break;
...
window.location=link;
    ...
    $.post("https://smurfhotel.nl/smurf-imaging/avatarimage.php", {url: url})
    .done(function(data)
    {
    var data = data.split('|');
