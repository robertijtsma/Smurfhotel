...
$cacheName = dirname(__FILE__)."/dfhdfhdfnbrtbhufd/cache/part_".$inputSize."_".$inputPartAction."_".$inputPartType."_".$inputPartID."_".implode("-", $inputPartColor)."_".$inputDirection.".".$inputFormat;
