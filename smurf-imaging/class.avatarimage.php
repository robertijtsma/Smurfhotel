...
define("PATH_RESOURCE",	dirname(__FILE__)."/dfhdfhdfnbrtbhufd/");
...
class AvatarImage
{
	...
	function AvatarImage($figure, $direction, $headDirection, $action, $gesture, $frame, $isHeadOnly, $scale)
	{
		...
		$this->settings	= array(
							"map"			=> $this->getJSON(PATH_RESOURCE."8655695956.json"),
							"figuredata"	=> $this->getJSON(PATH_RESOURCE."5745675675.json"),
