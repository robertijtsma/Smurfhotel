...
<html lang="en">
    <head>
        ...
        <title>{hotelName} - Experten</title>
...
<body>
 ...
 <div class='subnaviarea'>
  <div class='subnavi'>
	...
	<a href="{url}/mod">Moderatoren</a><div class='chosen'>I</div>
	<a href="{url}/exp"><div class='chosen'>Experten</div></a>
  </div>
 </div>
 <div class='content'>
	<div class='staffs'>
...
global $engine;
                            $GetRanks = $engine->query("SELECT id,name FROM ranks WHERE id =6 ORDER BY id DESC");
