    ...
    <body id="home">
        ...
        <div id="header-container">
            <div id="header" class="clearfix">
                <h1><a href="{url}/"></a></h1>
                <ul id="navi">
                    <li><a href="{url}/index">Startseite</a><span></span></li>
                    <li><a href="{url}/register">Anmelden</a><span></span></li>
					<li class="metab selected"><strong>Information</strong><span></span></li>
                </ul>
