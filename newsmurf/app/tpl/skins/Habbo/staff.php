...
<body>
 ...
 <div class='subnaviarea'>
  <div class='subnavi'>
	<a href="{url}/staff"><div class='chosen'>Management</div></a><div class='chosen'>I</div>
	<a href="{url}/mod">Moderation</a><div class='chosen'>I</div>
...
global $engine;
                            $GetRanks = $engine->query("SELECT id,name FROM ranks WHERE id =11 or id = 10 ORDER BY id DESC");
