...
<html lang="en">
    <head>
        ...
        <title>{hotelName} - Neuigkeiten</title>
...
<body>
 ...
 <div class='content'>
  ...
  <div class='info' style='width:700px;max-width: 60%;'>
	<h2>{newsTitle}</h2><hr>
	<div style='color:#888'>geschrieben am {newsDate}</div>
	<div class="topstory"  style="margin-right:20px;background-image: url({url}/ase/ts/{newsIMG});"></div>
