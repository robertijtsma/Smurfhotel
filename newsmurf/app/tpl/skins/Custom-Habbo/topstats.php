...
<html lang="en">
    <head>
        ...
        <title>{hotelName} - Toplijst</title>
            ...
            <div id="navi2-container" class="pngbg">
                <div id="navi2" class="pngbg clearfix">
                    <ul>
                        ...
                        <li><a href="{url}/staff">Medewerkers</a></li>
						
						<li class="selected">Toplijst</li>
            ...
            <div id="container">
                <div id="content" style="position: relative" class="clearfix">
                    <div id="column1" class="column">
						<div class="habblet-container ">
							<div class="cbb clearfix blue ">
                                <h2 class="title">Mensen met de meeste respect gekregen en gegeven</h2>
						...
						<div class="habblet-container ">
							<div class="cbb clearfix blue ">
                                <h2 class="title">Meeste Cadeau's gekregen en gegeven</h2>
								<div style="padding:5px">
								<?php
						...
						<div class="habblet-container ">
							<div class="cbb clearfix blue ">
                                <h2 class="title">Meeste kamer bezoeken & hoogste achievement score</h2>
								<div style="padding:5px">
								<?php
                    ...
                    <div id="column2" class="column">
                        <div class="habblet-container ">
                            <div class="cbb clearfix blue ">
                                <h2 class="title">Top 5 rijkste Smurfen in credits</h2>
                                <div style="padding:5px">
						...
						<div class="cbb clearfix blue ">
							<h2 class="title">Top 5 rijkste Smurfen in pixels</h2>
							<div style="padding:5px">
						...
						?>
						<div class="cbb clearfix blue ">
							<h2 class="title">Actieve Smurfen</h2>
							<div style="padding:5px">
								<table style="width: 100%">
									<?php
