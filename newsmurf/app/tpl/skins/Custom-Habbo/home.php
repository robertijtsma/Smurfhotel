...
<html lang="en">
    <head>
        ...
        <title>{hotelName} - Mijn Pagina</title>
...
<ul id="subnavi-search-links">
					...
					<div id="to-hotel">
<a href="{url}/logout" class="new-button red-button" style="margin-right:5px;margin-left:5px;"><b>Log out</b><i></i></a>

                        <a href="{url}/client" class="new-button green-button" target="eac955c8dbc88172421193892a3e98fc7402021a" onclick="HabboClient.openOrFocus(this); return false;"><b>Ga in {hotelName}</b><i></i></a>
            ...
            <div id="navi2-container" class="pngbg">
                <div id="navi2" class="pngbg clearfix">
                    <ul>
						...
						<li class="selected">Mijn Pagina</li>
            ...
            <div id="container">
                <div id="content" style="position: relative" class="clearfix">
                       ...
                       <div class="cbb clearfix orange ">
                        ...
                        <h2 class='title' style='font-size:12px;font-family: "Tahoma",Verdana,Arial;'><?php echo mysql_num_rows($getEntries); ?> Gastenboek</h2>
                        ...
                        // Hent gjestebokinnlegg
                                ...
                                echo "<center>Er zijn nog geen posts!</center>";
                                } else {
                        ...
                        <div style="margin:-10px;">
                            ...
                            <img src="http://www.habbo.nl/habbo-imaging/avatarimage?figure=<?php echo $data['look']; ?>" alt="avatar" class="rotate" align="left">     
                                ...
                                <br /><br />
                                Geregistreerd op: <?php echo date("j-M-Y", $data['account_created']); ?>.
                                <br><?php echo $username; ?> is een <?php
...
?>!
                ...
                <div class="cbb clearfix blue">
                        <h2 class='title' style='font-size:12px;text-align:left;font-family: "Tahoma",Verdana,Arial;'>Smurf info</h2>
                        ...
                        <p style='padding-bottom:4px;'><img src='/app/tpl/skins/custom-habbo/images/3.png'/> <?php echo $resp; ?> Respect</p>
                        <p style='padding-bottom:4px;'><img src='/app/tpl/skins/custom-habbo/images/4.png'/> <?php echo $achivement; ?> Achivement punten</p>
                </div>
                </div>
                </div>
                ...
                //(hvis bruker ikke har 10 skilt henter den alle brukeren har).
                        ...
                        echo '<img src="http://smurfhotel.nl/r63/c_images/album1584/'.$badge.'.gif" style="margin-right: 10px;" />';
