                                    ...
                                    <div class="box-content">
                                        <div id="settingsNavigation">
                                            <ul>
												...
												<li class=" "><a href="account"> Account Instellingen</a></li>
												<li class=" "><a href="tradesettings">Ruil Instellingen</a></li>
                            ...
                            <div class="habblet-container " style="float:left; width: 560px;">
                                <div class="cbb clearfix settings">
									...
									?>
                                            ...
                                            <h3>Status</h3>
                                            <p>Je status is wat iedereen kan zien als iemand op je klikt in de client.</p>
											...
											if ( $x1 = '1' ) {
											echo "<input type='checkbox' name='bf' value='2' ".$ch1['0'].">Weiger vrienden verzoeken:";
											} else {
											echo "<input type='checkbox' name='bf' value='1' ".$ch1['1'].">Accepteer vrienden verzoeken:";
											}
											echo "<br><br>
											";
											...
											echo "
											<h3>Online status</h3>
											<p>Kies wie je online zien:</p>
											<input type='radio' name='os' value='1' ".$ch2['1'].">Niemand
											<input type='radio' name='os' value='0' ".$ch2['0'].">Iedereen
											<br><br>
											";
											...
											<input type='radio' name='fm' value='1' ".$ch3['1'].">Niemand
											<input type='radio' name='fm' value='0' ".$ch3['0'].">Mijn Vrienden
											";
											?>
											<br>
											</br>
