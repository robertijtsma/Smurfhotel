...
<link rel="shortcut icon" href="{url}/web-gallery/v2/favicon.ico" type="image/vnd.microsoft.icon" />
                ...
                <ul id="gender-choices">
                    <li>
                        ...
                        <span class="gender-choice">
                            <img alt="male" src="{url}/app/tpl/skins/Custom-Habbo/images/boy.png" width="60" height="60"><br>Boy
                        </span>
                    </li>
                    <li>
                        <span class="bgtop"></span>
                        <span class="bgbottom"></span>
                        <span class="gender-choice">
                            <img alt="female" src="{url}/app/tpl/skins/Custom-Habbo/images/girl.png" width="60" height="60"><br>Girl
                        </span>
                    </li>
                </ul>
            </div>
